...
def test_uuid_namespace_md5_usedforsecurity_false() -> None:
    """Verify MD5 namespace helper passes usedforsecurity=False (Bandit B324)."""
...
def test_uuid_namespace_md5_output_stable() -> None:
    """Verify MD5 namespace output remains stable after usedforsecurity fix."""
    from superset.key_value.utils import _uuid_namespace_from_md5
